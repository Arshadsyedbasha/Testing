...
public class Mayoclinic {
    ...
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("C:\\Users\\ARSHAD\\Desktop\\Model\\Model\\mayoclinic\\logandreport\\report1.html");
    ...
    public void test() throws IOException, InterruptedException
    {
        ...
        PropertyConfigurator.configure("C:\\Users\\ARSHAD\\Desktop\\Model\\Model\\mayoclinic\\mc\\src\\main\\resources\\log4j2.properties");
        WebDriverManager.chromedriver().setup();
        driver = new ChromeDriver();
        driver.manage().window().maximize();
        FileInputStream fs = new FileInputStream("C:\\Users\\ARSHAD\\Desktop\\Model\\Model\\mayoclinic\\mclinic.xlsx");
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path = "C:\\Users\\ARSHAD\\Desktop\\Model\\Model\\mayoclinic"+result.getName()+".png";
